...
#import "DHNetWorkingTask.h"
#import "URLKeyManager.h"
#import <UIKit/UIKit.h>

@implementation DHNetWorkingTask
...
//        [KVNProgress showErrorWithStatus:@"您正处于非WIFI状态下"];
    ...
    [mannager GET:URL parameters:dictionary progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        NSDictionary *data = [NSJSONSerialization JSONObjectWithData:responseObject options:NSJSONReadingMutableContainers error:NULL];
        block(data);
