 ...
 */
@interface THTextLinePositionModifier : NSObject <YYTextLinePositionModifier>
...
@interface TodayHistoryLayout : NSObject

- (instancetype)initWithStatus:(NSArray *)status;
- (void)layout; ///< 计算布局
