...
- (id)initWithPropertiesDictionary:(NSDictionary *)dic
{
    ...
    if (self) {
        if (dic != nil) {
            ...
            self.setWeeks = [self.seWeek componentsSeparatedByString:@"-"];
        }
    }
    return self;
}
...
- (NSDictionary *)toDictionary {
    ...
    [dic setObject:self.lesson forKey:@"lessons"];
    [dic setObject:self.lessonsNum forKey:@"lessonsNum"];
    [dic setObject:self.courseCode forKey:@"courseCode"];
    [dic setObject:self.courseName forKey:@"courseName"];
    [dic setObject:self.classRoom forKey:@"claRoom"];
    [dic setObject:self.teacherName forKey:@"teacherName"];
    [dic setObject:self.seWeek forKey:@"seWeek"];

    return dic;
}

- (NSDictionary *)toLocalDictionary {
    NSMutableDictionary *dic = [NSMutableDictionary dictionaryWithCapacity:0];
    ...
    [dic setObject:self.courseName forKey:@"courseName"];
    [dic setObject:self.classRoom forKey:@"claRoom"];
    [dic setObject:self.teacherName ? self.teacherName : @"暂无" forKey:@"teacherName"];
    [dic setObject:self.seWeek forKey:@"seWeek"];
